...
void ui_scrWallpaper_screen_init(void)
{
    ...
    lv_obj_set_style_bg_color(ui_scrWallpaper, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_lblScreenClock, -198);
    lv_obj_set_y(ui_lblScreenClock, -47);
    ...
    lv_obj_set_width(ui_Container2, 696);
    lv_obj_set_height(ui_Container2, 389);
    lv_obj_set_x(ui_Container2, 17);
    ...
    lv_obj_set_x(ui_imgScreenLogo, -4);
    ...
    lv_img_set_zoom(ui_imgScreenLogo, 110);
