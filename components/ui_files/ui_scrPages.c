...
void ui_scrPages_screen_init(void)
{
    ...
    lv_obj_set_x(ui_lblSensorsB, -108);
    lv_obj_set_y(ui_lblSensorsB, 100);
    ...
    lv_obj_set_x(ui_lblWaterLevelsB, 92);
    lv_obj_set_y(ui_lblWaterLevelsB, 99);
    ...
    lv_obj_set_x(ui_lblRGBsB, 290);
    lv_obj_set_y(ui_lblRGBsB, 103);
